...
resourcename="sqoin1"  # lower case, only
resourcegroup="sqoin1_rg"
...
# git clone https://github.com/apilogicserver/sqoin1.git
# cd sqoin1
...
az group create --name sqoin1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group sqoin1_rg --sku S1 --is-linux
az container create --resource-group sqoin1_rg --name sqoin1 --image apilogicserver/sqoin1:latest --dns-name-label sqoin1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//sqoin1.westus.azurecontainer.io:5656'
