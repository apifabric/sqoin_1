...
@Component({
  selector: 'Semester-home',
  templateUrl: './Semester-home.component.html',
  styleUrls: ['./Semester-home.component.scss']
})
export class SemesterHomeComponent implements AfterViewInit {
