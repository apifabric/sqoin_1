...
@Component({
  selector: 'CourseOffering-home',
  templateUrl: './CourseOffering-home.component.html',
  styleUrls: ['./CourseOffering-home.component.scss']
})
export class CourseOfferingHomeComponent implements AfterViewInit {
